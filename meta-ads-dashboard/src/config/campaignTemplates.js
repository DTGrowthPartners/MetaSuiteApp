...
export const CTA_OPTIONS = [
  ...
  { value: 'VIEW_INSTAGRAM_PROFILE', label: 'Ir al perfil de Instagram' }
];
...
export const CAMPAIGN_TEMPLATES = [
  ...
  // ==========================================
  // 3. CLIENTES POTENCIALES A WHATSAPP
  // ==========================================
  {
    id: 'leads_whatsapp',
    name: 'Clientes potenciales a WhatsApp',
    icon: 'clipboard-list',
    category: 'Clientes potenciales',
    description: 'Captura clientes potenciales a través de WhatsApp. Meta optimiza para personas que probablemente te escriban.',
  ...
  // ==========================================
  // 3B. CLIENTES POTENCIALES A INSTAGRAM DM
  // ==========================================
  {
    id: 'leads_instagram',
    name: 'Clientes potenciales a Instagram',
    icon: 'camera',
    category: 'Clientes potenciales',
    description: 'Captura clientes potenciales a través de Instagram Direct. Meta optimiza para maximizar el número de clientes potenciales por DM.',
    objective: 'OUTCOME_LEADS',
    specialAdCategories: [],
    buyingType: 'AUCTION',
    adSetConfig: {
      conversionLocation: 'LEAD_FROM_IG_DIRECT',
    ...
    adConfig: {
      allowedFormats: ['SINGLE_IMAGE', 'SINGLE_VIDEO', 'CAROUSEL'],
      defaultFormat: 'SINGLE_IMAGE',
      destinationConfig: { type: 'LEAD_FROM_IG_DIRECT', requiresUrl: false, requiresInstagram: true },
      allowedCtas: ['INSTAGRAM_MESSAGE', 'GET_QUOTE', 'CONTACT_US'],
    ...
    creativeContent: {
      ...
      descriptions: [
        'Envía un DM y recibe tu cotización personalizada en minutos.',
        'Asesoría profesional gratuita. Solo escribe "Quiero info" por DM.',
        'Te respondemos en menos de 5 minutos con toda la información.',
        'Sin compromiso de compra. Pregunta lo que necesites por Instagram.',
        'Nuestro equipo de asesores te atiende ahora mismo por DM.'
      ],
      primaryTexts: [
        '¿Buscas la mejor opción? Escríbenos por DM en Instagram y recibe una cotización personalizada sin compromiso. Te respondemos al instante.',
        'Más de 500 personas nos contactaron esta semana por Instagram. Envía un DM y descubre por qué somos la mejor opción para ti.',
        '¡Atención! Estamos ofreciendo asesoría gratuita por Instagram Direct. Envía un mensaje ahora y un experto te guía paso a paso.',
        'No compres a ciegas. Primero escríbenos por DM, te damos toda la información y luego tú decides. Sin presión.',
        'Recibe una propuesta personalizada en minutos. Solo envía un "Hola" por DM y nuestro equipo hace el resto.'
      ],
      ctas: ['INSTAGRAM_MESSAGE', 'INSTAGRAM_MESSAGE', 'GET_QUOTE', 'INSTAGRAM_MESSAGE', 'CONTACT_US']
    }
  },
  ...
  // ==========================================
  {
    ...
    adConfig: {
      ...
      allowedCtas: ['VIEW_INSTAGRAM_PROFILE', 'LEARN_MORE', 'CONTACT_US', 'SHOP_NOW', 'GET_QUOTE'],
      defaultCta: 'VIEW_INSTAGRAM_PROFILE',
      trackingConfig: { requiresPixel: false }
    },
    creativeContent: {
      headlines: [
      ...
      ctas: ['VIEW_INSTAGRAM_PROFILE', 'VIEW_INSTAGRAM_PROFILE', 'VIEW_INSTAGRAM_PROFILE', 'VIEW_INSTAGRAM_PROFILE', 'VIEW_INSTAGRAM_PROFILE']
    }
  },
