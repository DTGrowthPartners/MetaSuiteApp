...
export const CAMPAIGN_TEMPLATES = [
  ...
  // ==========================================
  // 3B. CLIENTES POTENCIALES A INSTAGRAM
  // ==========================================
  {
    id: 'leads_instagram',
    ...
    icon: 'camera',
    category: 'Clientes potenciales',
    description: 'Captura clientes potenciales a través de Instagram Direct. Meta optimiza para personas que probablemente te escriban por DM.',
    objective: 'OUTCOME_LEADS',
    specialAdCategories: [],
    buyingType: 'AUCTION',
    adSetConfig: {
    ...
    adConfig: {
      allowedFormats: ['SINGLE_IMAGE', 'SINGLE_VIDEO', 'CAROUSEL'],
      defaultFormat: 'SINGLE_IMAGE',
      destinationConfig: { type: 'INSTAGRAM_DIRECT', requiresUrl: false, requiresInstagram: true },
