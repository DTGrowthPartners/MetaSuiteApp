...
const strings = {
  ...
  select_account_first: { es: 'Selecciona una cuenta publicitaria primero', en: 'Select an ad account first' },
  ig_account: { es: 'Cuenta de Instagram', en: 'Instagram Account' },
  ig_no_accounts: { es: 'No se encontraron cuentas de Instagram', en: 'No Instagram accounts found' },
  ig_none: { es: 'Sin Instagram', en: 'No Instagram' },
  ig_hint_no_accounts_profile: { es: 'Se usará la cuenta de Instagram vinculada a tu página para dirigir tráfico al perfil', en: 'Your Page\u2019s linked Instagram account will be used for profile traffic ads' },
  ig_hint_no_accounts: { es: 'Vincula una cuenta de Instagram a tu página de Facebook para publicar en Instagram', en: 'Link an Instagram account to your Facebook Page to publish on Instagram' },
  business_managers_count: { es: 'administradores comerciales', en: 'Business Managers' },
  ...
  page_hint: { es: 'Página desde la que se publicará el anuncio (cargada desde tus Business Managers vinculados).', en: 'Select the Facebook Page from your connected Business Managers that will publish this ad.' },
  ig_hint: { es: 'Cuenta profesional de Instagram vinculada a tu página de Facebook.', en: 'Select the Instagram professional account linked to your Facebook Page.' },
  // Destination section
